...
- Centralized locators in `ui/locators/`
...
Create `ui/locators/my-journey.locator.ts`:
...
import { myJourneyLocator } from '../ui/locators/my-journey.locator';
...
- Locators centralized in `ui/locators/`
